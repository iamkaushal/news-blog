...
<body>
		 	...
		 	<?php
				...
				$sql = "SELECT * FROM posts  WHERE approved = 1 LIMIT 8 " ;
				...
				if ($result->num_rows > 0) {
				    ...
				    while($row = $result->fetch_assoc()) {
						...
						echo '<div class="section post medium-post post-content col-sm-5"  style="display: inline-block; margin: 1%; float : left;">								
						...
						<br>
						<a href="post.php?id=' .$row['id'] .'" style="color: Blue;" >Read More...</a></div>
						';
